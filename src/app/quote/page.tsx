...
import { quote } from '@/app/api/libs/quote';
import { CurrentConfig, Environment } from "@/app/api/libs/config";
...
const Quoting = () => {
    ...
    const [currentEnv, setCurrentEnv] = useState<Environment>(Environment.NONE);
    ...
    const handleOnClick = async () => {
        // const inputElement = document.getElementById("USDC") as HTMLInputElement;
        try{
        const response = await axios.post('/api/quote', {amountIn: inputAmount, env: currentEnv})
